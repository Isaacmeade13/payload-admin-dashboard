...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE IF NOT EXISTS "venue" (
  	...
  	"catering_and_drinks_additional_info" varchar,
  	"tables_and_seating_is_available" boolean,
  	"tables_and_seating_additional_info" varchar,
  	"alcoholic_beverages_is_available" boolean,
  	"alcoholic_beverages_additional_info" varchar,
  	"restrooms_is_available" boolean,
  	"restrooms_additional_info" varchar,
  	"music_and_a_v_is_available" boolean,
  	"music_and_a_v_additional_info" varchar,
  	"allowed_events_is_available" boolean,
  	"allowed_events_additional_info" varchar,
  	"accommodation_is_available" boolean,
  	"accommodation_additional_info" varchar,
  	"parking_is_available" boolean,
  	"parking_additional_info" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "_venue_v" (
  	...
  	"version_benefits" varchar,
  	"version_rating" numeric,
  	"version_catering_and_drinks_is_available" boolean,
  	"version_catering_and_drinks_additional_info" varchar,
  	"version_tables_and_seating_is_available" boolean,
  	"version_tables_and_seating_additional_info" varchar,
  	"version_alcoholic_beverages_is_available" boolean,
  	"version_alcoholic_beverages_additional_info" varchar,
  	"version_restrooms_is_available" boolean,
  	"version_restrooms_additional_info" varchar,
  	"version_music_and_a_v_is_available" boolean,
  	"version_music_and_a_v_additional_info" varchar,
  	"version_allowed_events_is_available" boolean,
  	"version_allowed_events_additional_info" varchar,
  	"version_accommodation_is_available" boolean,
  	"version_accommodation_additional_info" varchar,
  	"version_parking_is_available" boolean,
  	"version_parking_additional_info" varchar,
